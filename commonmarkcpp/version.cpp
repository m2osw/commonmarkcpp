...
/** \file
 * \brief The version of the Common Mark C++ at compile time.
 *
 * This file records the commonmarkcpp library version at compile time.
 *
...
{
    return COMMONMARKCPP_VERSION_MAJOR;
}
...
{
    return COMMONMARKCPP_VERSION_MINOR;
}
...
{
    return COMMONMARKCPP_VERSION_PATCH;
}
...
{
    return COMMONMARKCPP_VERSION_STRING;
}
